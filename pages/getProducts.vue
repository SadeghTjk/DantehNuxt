        ...
        <div class="row rtl p-5">
            <div class="col-12">
              <button id="delete" type="submit" @click="del" class="mb-3">حذف</button>
                ...
                <span class="product-container" v-for="(product,index) in all" :key="index">
...
loading: {
  ...
  methods: {
    ...
    async getall() {
    this.all = (await this.$axios.get('https://www.all.ir/wp-json/askwp/v1/products')).data.products;
  },
    del(){
      this.all = {}
    }
